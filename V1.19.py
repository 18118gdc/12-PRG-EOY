...
def MenuPage(PizzaData,OrderType,Name,Address,Phone):
    ...
    CanBut.place(x=670,y=390,height=30,width=110)
    CheckBut.place(x=820,y=390,height=30,width=110)
...
def PopOutFun(PizzaData,PizzaNum,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot):
    ...
    AddBox.place(x=200,y=90,height=31,width=20)
    AddBut.place(x=220,y=89,width=99)
    Exit.place(x=219,y=20,height=31,width=100)
    RetBut.place(x=199,y=126,width=120)
    return
...
def SetDis(PizzaOrder,Name,Address,Phone,OrderType,CostTot):
    ...
    SubText2 = Label(Win4,text=("Order Completed"),bg=("#fff2cc"),fg=("#000000"),font=("{Trebuchet MS} 14"))
    ...
    if ((OrderType) == ("Delivery")):    
        ...
        PhonText.place(x=35,y=95)
        PhonBox.place(x=36,y=115,width=155,height=22)
        AddrText.place(x=35,y=140)
        AddrBox.place(x=36,y=160,width=155,height=22)
    ...
    SubText2.pack()
    SubText3.place(x=505,y=100)
    OrderBack.place(x=450,y=100,height=180,width=200)
    NameText.place(x=35,y=50)
    NameBox.place(x=36,y=70,width=155,height=22)
 
    DateText.pack()
    DateBox.pack()
    RepBut.pack()
    Exit.place(x=450,y=285,width=200,height=30)
    try:
        Order1Text.place(x=460,y=140) 
        Order1Cost.place(x=590,y=140) 
        Order2Text.place(x=460,y=160)
        Order2Cost.place(x=590,y=160)
        Order3Text.place(x=460,y=180)
        Order3Cost.place(x=590,y=180)
        Order4Text.place(x=460,y=200)
        Order4Cost.place(x=590,y=200)
        Order5Text.place(x=460,y=220)
        Order5Cost.place(x=590,y=220)
    except:
        ()
    OrderTotText.place(x=(460),y=(140+(20*(len(PizzaOrder[0])))))
    OrderTotCost.place(x=(590),y=(140+(20*(len(PizzaOrder[0])))))
    return
