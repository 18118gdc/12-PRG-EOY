...
def MenuPage(PizzaData,OrderType,Name,Address,Phone):
    ...
    ExitBut = Button(Win2,text=("Exit"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10 italic"),command=lambda:(ExitFun(Win2)))
...
def SetDis(PizzaOrder,Name,Address,Phone,OrderType,CostTot):
    ...
    ContBut = Button(Win4,text=("Enter Another Order"))
    Exit = Button(Win4,text=("Exit"),command=(lambda:(ExitFun(Win4))))
