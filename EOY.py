...
def CustPage(PizzaData):
    ...
    Win1.iconbitmap("E:/PRG/12PRG/Python Coding/EOY/Logo.ico")

    LogoRaw = PhotoImage(file="E:/PRG/12PRG/Python Coding/EOY/Logo.png")
...
def MenuPage(PizzaData,OrderType,Name,Address,Phone):
    global PizzaOrder
    global Win2
    PizzaOrder = [[]for main in range(3)]
    Win2 = Toplevel()
    Win2.title("Tony's Pizza Menu")
    Win2.geometry("960x460")
    Win2.config(bg=("#fff2cc"))
    Win2.iconbitmap("E:/PRG/12PRG/Python Coding/EOY/Logo.ico")
    ...
    OrderQt1 = Label(Win2,text=(""),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
    OrderQt2 = Label(Win2,text=(""),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
    OrderQt3 = Label(Win2,text=(""),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
    OrderQt4 = Label(Win2,text=(""),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
    OrderQt5 = Label(Win2,text=(""),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
    ...
    OrderBut1 = Button(Win2,text=("X"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:SubFun(0,PizzaOrder,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderTextTot,OrderCostTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    ...
    Pizza1But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,0,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    Pizza2But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,1,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    Pizza3But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,2,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    Pizza4But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,3,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    Pizza5But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,4,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    Pizza6But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,5,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    Pizza7But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,6,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    Pizza8But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,7,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    Pizza9But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,8,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    Pizza10But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,9,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    Pizza11But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,10,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    Pizza12But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,11,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
    ...
    OrderCostTot.place(x=814,y=155)
...
def SubFun(OrderPos,PizzaOrder,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderTextTot,OrderCostTot,ErrorText,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5):
    if ((len(PizzaOrder[0]))<=0):
        ...
        if ((int(PizzaOrder[2][OrderPos]))>1):
            PizzaOrder[2][OrderPos]-=1
        else:
            PizzaOrder[0].pop(OrderPos)
            PizzaOrder[1].pop(OrderPos)
            PizzaOrder[2].pop(OrderPos)
...
def PopOutFun(PizzaData,PizzaNum,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5):
    try:
        global Win3
        Win3.destroy()
    except:
    ...
    Win3.iconbitmap("E:/PRG/12PRG/Python Coding/EOY/Logo.ico")
    ...
    AddBut = Button(Win3,text=("Add to Order"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:AddFun(PizzaData,PizzaNum,AddBox.get(),OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,ErrorText3,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5))
...
def AddFun(PizzaData,PizzaNum,PizzaQt,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot,ErrorText2,ErrorText3,OrderQt1,OrderQt2,OrderQt3,OrderQt4,OrderQt5):
    global PizzaOrder
    PizzaOrderSize = int(0)
    for main in range(len(PizzaOrder[2])):
        PizzaOrderSize+=int(PizzaOrder[2][main])
    try:
        PizzaQt=int(PizzaQt)
        if ((PizzaQt)<=0):
            ...
            Multi = "false"
            for main in range(len(PizzaOrder[2])):
                if ((PizzaNum+1) == (int(PizzaOrder[0][main][0:(PizzaOrder[0][main].index("."))]))):
                    PizzaOrder[2][main]+=PizzaQt
                    Multi = "true"
            if Multi == "false":
                OrderPos = ReOrder(PizzaNum)
                PizzaOrder[0].insert(OrderPos,PizzaData[PizzaNum][0])
                PizzaOrder[1].insert(OrderPos,PizzaData[PizzaNum][1])
                PizzaOrder[2].insert(OrderPos,PizzaQt)
            ...
            OrderCost1.config(text=("${:,.2f}".format(float(PizzaOrder[1][0]))))
            OrderQt1.config(text=("x"+str(PizzaOrder[2][0])))
            OrderBut1.place(x=880,y=157,height=20,width=27)
            OrderText1.place(x=675,y=155)
            OrderCost1.place(x=814,y=155)
            OrderQt1.place(x=857,y=155)
            try:
                OrderText2.config(text=((PizzaOrder[0][1])))
                OrderCost2.config(text=("${:,.2f}".format(float(PizzaOrder[1][1]))))
                OrderQt2.config(text=("x"+str(PizzaOrder[2][1])))
                OrderBut2.place(x=880,y=197,height=20,width=27)
                OrderText2.place(x=675,y=195)
                OrderCost2.place(x=814,y=195)
                OrderQt2.place(x=857,y=195)
                try:
                    OrderText3.config(text=((PizzaOrder[0][2])))
                    OrderCost3.config(text=("${:,.2f}".format(float(PizzaOrder[1][2]))))
                    OrderQt3.config(text=("x"+str(PizzaOrder[2][2])))
                    OrderBut3.place(x=880,y=237 ,height=20,width=27)
                    OrderText3.place(x=675,y=235)
                    OrderCost3.place(x=814,y=235)
                    OrderQt3.place(x=857,y=235)
                    try:
                        OrderText4.config(text=((PizzaOrder[0][3])))
                        OrderCost4.config(text=("${:,.2f}".format(float(PizzaOrder[1][3]))))
                        OrderQt4.config(text=("x"+str(PizzaOrder[2][3])))
                        OrderBut4.place(x=880,y=277,height=20,width=27)
                        OrderText4.place(x=675,y=275)
                        OrderCost4.place(x=814,y=275)
                        OrderQt4.place(x=857,y=275)
                        try:
                            OrderText5.config(text=((PizzaOrder[0][4])))
                            OrderCost5.config(text=("${:,.2f}".format(float(PizzaOrder[1][4]))))
                            OrderBut5.place(x=880,y=317,height=20,width=27)
                            OrderQt5.config(text=("x"+str(PizzaOrder[2][4])))
                            OrderText5.place(x=675,y=315)
                            OrderCost5.place(x=814,y=315)
                            OrderTextTot.place(x=675,y=355)
                            OrderCostTot.place(x=814,y=355)
                            OrderQt5.place(x=857,y=355) 
                        except:
                            OrderTextTot.place(x=675,y=315)
                            OrderCostTot.place(x=814,y=315)   
                    except:
                        OrderTextTot.place(x=675,y=275)
                        OrderCostTot.place(x=814,y=275) 
                except:
                    OrderTextTot.place(x=675,y=235)
                    OrderCostTot.place(x=814,y=235)
            except:
                OrderTextTot.place(x=675,y=195)
                OrderCostTot.place(x=814,y=195)
    except ValueError:
        ErrorText3.config(text="Error Invalid Qt.")
...
#Function that determines where in the list the new pizza added should be placed numerically
def ReOrder(PizzaNum):
    Order = [(PizzaNum+1)]
    for main in range(len(PizzaOrder[0])):
        Order.append(int(PizzaOrder[0][main][0:(PizzaOrder[0][main].index("."))]))
    Order.sort()
    OrderPos = Order.index((PizzaNum+1))
    return(OrderPos)
...
def CalcPizza(OrderType,PizzaOrder):
    ...
    for main in range(len(PizzaOrder[0])):
        try:   
            CostTot+= ((float(PizzaOrder[1][main]))*(int(PizzaOrder[2][main])))
        except ValueError:
            print("Cost Err.")
    return(CostTot)
...
def SetDis(PizzaOrder,Name,Address,Phone,OrderType,CostTot):
    ...
    Win4.iconbitmap("E:/PRG/12PRG/Python Coding/EOY/Logo.ico")
    ...
    try:
        OrderText1 = Label(Win4,text=(PizzaOrder[0][0]),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderCost1 = Label(Win4,text=("${:,.2f}".format(float(PizzaOrder[1][0]))),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderQt1 = Label(Win4,text=("x"+str(PizzaOrder[2][0])),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderText2 = Label(Win4,text=(PizzaOrder[0][1]),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderCost2 = Label(Win4,text=("${:,.2f}".format(float(PizzaOrder[1][1]))),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderQt2 = Label(Win4,text=("x"+str(PizzaOrder[2][1])),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderText3 = Label(Win4,text=(PizzaOrder[0][2]),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderCost3 = Label(Win4,text=("${:,.2f}".format(float(PizzaOrder[1][2]))),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderQt3 = Label(Win4,text=("x"+str(PizzaOrder[2][2])),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderText4 = Label(Win4,text=(PizzaOrder[0][3]),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderCost4 = Label(Win4,text=("${:,.2f}".format(float(PizzaOrder[1][3]))),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderQt4 = Label(Win4,text=("x"+str(PizzaOrder[2][3])),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderText5 = Label(Win4,text=(PizzaOrder[0][4]),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderCost5 = Label(Win4,text=("${:,.2f}".format(float(PizzaOrder[1][4]))),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
        OrderQt5 = Label(Win4,text=("x"+str(PizzaOrder[2][4])),bg=("#cfe2f3"),fg=("#000000"),font=("{Trebuchet MS} 10 italic"))
    except:
        ()
    ...
    try:
        OrderText1.place(x=260,y=112) 
        OrderCost1.place(x=395,y=112) 
        OrderQt1.place(x=440,y=112)
        OrderText2.place(x=260,y=132)
        OrderCost2.place(x=395,y=132)
        OrderQt2.place(x=440,y=132)
        OrderText3.place(x=260,y=152)
        OrderCost3.place(x=395,y=152)
        OrderQt3.place(x=440,y=152)
        OrderText4.place(x=260,y=172)
        OrderCost4.place(x=395,y=172)
        OrderQt4.place(x=440,y=172)
        OrderText5.place(x=260,y=192)
        OrderCost5.place(x=395,y=192)
        OrderQt5.place(x=440,y=192)
    except:
        ()
