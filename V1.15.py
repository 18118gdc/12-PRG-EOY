...
def MenuPage(PizzaData,OrderType,Name,Address,Phone):
    ...
    Pizza5But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,4,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5))
    ...
    #Pizza12Text.pack(x=30,y=195)
    #Pizza12But.place(x=30,y=220,height =30,width=140)

    ExitBut.pack()
    OrderBack.place(x=670,y=75,height="320",width="320")
    OrderText.place(x=780,y=85)
    OrderText1.pack()
    OrderText2.pack()
    OrderText3.pack()
    OrderText4.pack()
