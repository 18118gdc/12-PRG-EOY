...
def CustPage(PizzaData):
    ...
    SubTitle1 = Label(Win1,text="Tony's Pizza",fg=("#000000"),bg=("#fff2cc"),font =("{Trebuchet MS} 20 italic"))
    ...
    ContBut.place(x=30,y=127,height=30,width=144)
    ExitBut.place(x=220,y=127,height=30,width=144)
    CleaBut.place(x=420,y=127,height=30,width=144)
...
def MenuPage(PizzaData,OrderType,Name,Address,Phone):
    ...
    SubText1 = Label(Win2,text=("Tony's Pizza"),bg=("#fff2cc"),fg=("#000000"),font=("{Trebuchet MS} 24 italic"))
    SubText2 = Label(Win2,text = ("Standard Pizzas"),bg=("#fff2cc"),fg=("#000000"),font=("{Trebuchet MS} 14 italic")) 
    SubText3 = Label(Win2,text=("Gourmet Pizzas"),bg=("#fff2cc"),fg=("#000000"),font=("{Trebuchet MS} 14 italic"))
    ...
    Pizza8But.place(x=30,y=275,height=30,width=140)
    Pizza9Text.place(x=190,y=225)
    Pizza9But.place(x=190,y=275,height=30,width=140)
    Pizza10Text.place(x=350,y=225)
    Pizza10But.place(x=350,y=275,height=30,width=140)
    Pizza11Text.place(x=510,y=225)
    Pizza11But.place(x=510,y=275,height=30,width=140)
...
def PopOutFun(PizzaData,PizzaNum,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot):
    ...
    PizzaBack = Label(Win3,text=(""),bg=("#cfe2f3"))
    ...
    PizzaText1 = Label(Win3,text=(PizzaType),bg=("#cfe2f3"),font=("{Trebuchet MS} 10 italic"))
    PizzaText2 = Label(Win3,text=("${:,.2f}".format(float(PizzaData[PizzaNum][1]))),bg=("#cfe2f3"),font=("{Trebuchet MS} 10 italic"))
    ...
    SubText1.place(x=30,y=75)
    PizzaBack.place(x=27,y=80,height=25,width=120)
    PizzaText1.place(x=30,y=80)
    PizzaText2.place(x=100,y=80)
    PizzaInfoText.place(x=30, y=105)
    AddBox.pack()
    AddBut.pack()
    Exit.pack()
    RetBut.pack()
