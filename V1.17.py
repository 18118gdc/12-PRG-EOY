...
def CustPage(PizzaData):
    ...
    NameText.place(x=30,y=90)
    NameBox.place(x=30,y=120,height=22,width=144)
    PhonText.place(x=220,y=90)
    PhonBox.place(x=220,y=120,height=22,width=144)
    AddrText.place(x=420,y=90)
    AddrBox.place(x=420,y=120,height=22,width=144)

    ContBut.place(x=30,y=150,height=30,width=144)
    ExitBut.place(x=220,y=150,height=30,width=144)
    CleaBut.place(x=420,y=150,height=30,width=144)
...
def MenuPage(PizzaData,OrderType,Name,Address,Phone):
    ...
    OrderBut1 = Button(Win2,text=("X"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:SubFun(0,PizzaOrder,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderTextTot,OrderCostTot))
    OrderBut2 = Button(Win2,text=("X"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:SubFun(1,PizzaOrder,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderTextTot,OrderCostTot))
    OrderBut3 = Button(Win2,text=("X"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:SubFun(2,PizzaOrder,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderTextTot,OrderCostTot))
    OrderBut4 = Button(Win2,text=("X"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:SubFun(3,PizzaOrder,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderTextTot,OrderCostTot))
    OrderBut5 = Button(Win2,text=("X"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:SubFun(4,PizzaOrder,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderTextTot,OrderCostTot))
    
    Pizza1But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,0,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    Pizza2But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,1,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    Pizza3But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,2,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    Pizza4But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,3,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    Pizza5But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,4,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    Pizza6But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,5,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    Pizza7But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,6,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    Pizza8But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,7,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    Pizza9But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,8,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    Pizza10But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,9,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    Pizza11But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,10,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    Pizza12But = Button(Win2,text=("View More"),bg=("#6fa8dc"),fg=("#ffffff"),borderwidth=0,font=("{Trebuchet MS} 10"),command=lambda:PopOutFun(PizzaData,11,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
    ...
    SubText2.place(x=30,y=30)

    Pizza1Text.place(x=30,y=50)
    Pizza1But.place(x=30,y=75,height=30,width=140)
    Pizza2Text.place(x=190,y=50)
    Pizza2But.place(x=190,y=75,height=30,width=140)
    Pizza3Text.place(x=350,y=50)
    Pizza3But.place(x=350,y=75,height=30,width=140)
    Pizza4Text.place(x=510,y=50)
    Pizza4But.place(x=510,y=75,height=30,width=140)
    Pizza5Text.place(x=30,y=110)
    Pizza5But.place(x=30,y=135,height=30,width=140)
    Pizza6Text.place(x=190,y=110)
    Pizza6But.place(x=190,y=135,height=30,width=140)
    Pizza7Text.place(x=350,y=110)
    Pizza7But.place(x=350,y=135,height=30,width=140)
    SubText3.place(x=30,y=175)
    Pizza8Text.place(x=30,y=195)
    Pizza8But.place(x=30,y=220,height=30,width=140)
    Pizza9Text.place(x=190,y=195)
    Pizza9But.place(x=190,y=220,height=30,width=140)
    Pizza10Text.place(x=350,y=195)
    Pizza10But.place(x=350,y=220,height=30,width=140)
    Pizza11Text.place(x=510,y=195)
    Pizza11But.place(x=510,y=220,height=30,width=140)
    Pizza12Text.place(x=30,y=255)
    Pizza12But.place(x=30,y=280,height =30,width=140)

    ExitBut.place(x=820,y=30,height=30,width=110)
    OrderBack.place(x=670,y=75,height=285,width=260)
    OrderText.place(x=750,y=80)    
    OrderTextTot.place(x=675,y=130)
    OrderCostTot.place(x=820,y=130)
    CanBut.place(x=670,y=365,height=30,width=110)
    CheckBut.place(x=820,y=365,height=30,width=110)
    
    return

def SubFun(OrderPos,PizzaOrder,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderTextTot,OrderCostTot):
            ...
            try:
                ...
                try:
                    ...
                    try:    
                        ...
                        OrderTextTot.place(x=675,y=290)
                        OrderCostTot.place(x=820,y=290)
                    except:
                        ...
                        OrderTextTot.place(x=675,y=250)
                        OrderCostTot.place(x=820,y=250)                      
                except:
                    ...
                    OrderTextTot.place(x=675,y=210)
                    OrderCostTot.place(x=820,y=210)
            except:
                ...
                OrderTextTot.place(x=675,y=170)
                OrderCostTot.place(x=820,y=170)
        except:
...
def PopOutFun(PizzaData,PizzaNum,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot):
    try:
        global Win3
        Win3.destroy()
    except:
    ...
    AddBut = Button(Win3,text=("Add to Order"),bg=("#6fa8dc"),fg=("#ffffff"),font=("{Trebuchet MS} 10"),command=lambda:AddFun(len(PizzaOrder[0]),PizzaData,PizzaNum,AddBox.get(),OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot))
...
def AddFun(PizzaOrderSize,PizzaData,PizzaNum,PizzaQt,OrderText1,OrderText2,OrderText3,OrderText4,OrderText5,OrderBut1,OrderBut2,OrderBut3,OrderBut4,OrderBut5,OrderCost1,OrderCost2,OrderCost3,OrderCost4,OrderCost5,OrderCostTot,OrderType,OrderTextTot):
    global PizzaOrder
    try:
        PizzaQt=int(PizzaQt)
    except ValueError:
    ...
    if ((PizzaQt)<=0):
        ...
        OrderText1.config(text=((PizzaOrder[0][0])))
        OrderCost1.config(text=("${:,.2f}".format(float(PizzaOrder[1][0]))))
        OrderBut1.place(x=870,y=132,height=20,width=27)
        OrderText1.place(x=675,y=130)
        OrderCost1.place(x=820,y=130)
        try:
            OrderText2.config(text=((PizzaOrder[0][1])))
            OrderCost2.config(text=("${:,.2f}".format(float(PizzaOrder[1][1]))))
            OrderBut2.place(x=870,y=172,height=20,width=27)
            OrderText2.place(x=675,y=170)
            OrderCost2.place(x=820,y=170)
            try:
                OrderText3.config(text=((PizzaOrder[0][2])))
                OrderCost3.config(text=("${:,.2f}".format(float(PizzaOrder[1][2]))))
                OrderBut3.place(x=870,y=212,height=20,width=27)
                OrderText3.place(x=675,y=210)
                OrderCost3.place(x=820,y=210)
                try:
                    OrderText4.config(text=((PizzaOrder[0][3])))
                    OrderCost4.config(text=("${:,.2f}".format(float(PizzaOrder[1][3]))))
                    OrderBut4.place(x=870,y=252,height=20,width=27)
                    OrderText4.place(x=675,y=250)
                    OrderCost4.place(x=820,y=250)
                    try:
                        OrderText5.config(text=((PizzaOrder[0][4])))
                        OrderCost5.config(text=("${:,.2f}".format(float(PizzaOrder[1][4]))))
                        OrderBut5.place(x=870,y=292,height=20,width=27)
                        OrderText5.place(x=675,y=290)
                        OrderCost5.place(x=820,y=290)
                        OrderTextTot.place(x=675,y=330)
                        OrderCostTot.place(x=820,y=330) 
                    except:
                        OrderTextTot.place(x=675,y=290)
                        OrderCostTot.place(x=820,y=290)   
                except:
